...
cpM  =  "/usr/local/saspy/log4j.jar"
cpM += ":/usr/local/saspy/sas.security.sspi.jar"
cpM += ":/usr/local/saspy/sas.svc.connection.jar"
cpM += ":/usr/local/saspy/sas.core.jar"
cpM += ":/usr/local/saspy/saspyiom.jar"


samctr = {'java'   : '/usr/bin/java',
            'iomhost'   : 'sas_94v3',
            'iomport'   : 8591,
            'encoding'  : 'latin1',
            'classpath' : cpM
